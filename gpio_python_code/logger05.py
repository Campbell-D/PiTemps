...
# v05 Add output for the Homebridge plugin homebridge-http-thermometer
# https://github.com/jhemz/homebridge-http-thermometer-custom
# or
# https://github.com/Tommrodrigues/homebridge-http-thermometer#readme
# API Interfacing
